...
png("plot4.png")
orig_par <- par(mfrow=c(2,2))

plot(subset$Time, subset$Global_active_power, ylab="Global Active Power", main="", xlab="", type="l")

plot(subset$Time, subset$Voltage, ylab="Voltage", main="", xlab="datetime", type="l")
...
plot(subset$Time, subset$Global_reactive_power, ylab="Global_reactive_power", main="", 
